...
const defaultOrganization: BountyOrganization = {
  id: "org-boundless",
  name: "Boundless",
  logo: "/logo.svg",
  slug: "boundless",
...
const defaultProject: BountyProject = {
  id: "proj-bounties",
...
export function makeMockBounty(overrides: Partial<Bounty> = {}): Bounty {
  return {
    id: "mock-bounty-id",
    type: "FIXED_PRICE" as BountyType,
    ...
    githubIssueNumber: 1,
    description:
      "## Mock Bounty\n\nThis is a mock bounty for testing purposes.",
    rewardAmount: 100,
    rewardCurrency: "USDC",
...
export function makeMockBounties(): Bounty[] {
  const organizations: BountyOrganization[] = [
    defaultOrganization,
    {
      id: "org-soroban-kit",
      name: "Soroban Kit",
  ...
  const projects: BountyProject[] = [
    defaultProject,
    { id: "proj-platform", title: "Platform", description: null },
    { id: "proj-sdk", title: "SDK", description: null },
    { id: "proj-zkp", title: "ZKP", description: null },
  ];
  ...
  const bounties: Bounty[] = [
    ...
    },
    {
      ...
      projectId: "proj-sdk",
      project: projects[2],
      githubIssueUrl: "https://github.com/stellar-privacy/sdk/issues/7",
      githubIssueNumber: 7,
...
export const mockBounties = makeMockBounties();
